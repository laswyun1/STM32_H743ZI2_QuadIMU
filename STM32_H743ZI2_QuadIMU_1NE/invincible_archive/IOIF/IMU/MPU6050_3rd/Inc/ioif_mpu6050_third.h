...
#ifndef MPU6050_THIRD_INC_IOIF_MPU6050_THIRD_H_
#define MPU6050_THIRD_INC_IOIF_MPU6050_THIRD_H_
...
#define IOIF_MPU6050_THIRD_BUFF_SIZE        32

#define IOIF_MPU6050_THIRD_TRIALS           10
#define IOIF_MPU6050_THIRD_STRAT_UP_DELAY   10
#define IOIF_MPU6050_THIRD_TIMEOUT          1
 ...
 */
typedef enum _IOIF_6AxisState3_t {
    IOIF_IMU6AXIS_THIRD_STATUS_OK = 0,
    IOIF_IMU6AXIS_THIRD_STATUS_ERROR,
    IOIF_IMU6AXIS_THIRD_STATUS_BUSY,
    IOIF_IMU6AXIS_THIRD_STATUS_TIMEOUT,
} IOIF_6AxisState3_t;

/**
 * @brief Structure to hold the data from the 6-axis IMU.
 */
typedef struct _IOIF_6AxisData3_t {
    float accX;
    float accY;
    float accZ;
...
IOIF_6AxisState3_t IOIF_Init6Axis3(I2C_HandleTypeDef* i2c);
IOIF_6AxisState3_t IOIF_Get6AxisValue3(IOIF_6AxisData3_t* imuData);


#endif /* MPU6050_THIRD_INC_IOIF_MPU6050_THIRD_H_ */
