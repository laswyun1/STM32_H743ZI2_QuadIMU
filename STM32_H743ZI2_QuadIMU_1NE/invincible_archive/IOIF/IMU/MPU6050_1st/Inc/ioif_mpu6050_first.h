...
#ifndef MPU6050_FIRST_INC_IOIF_MPU6050_FIRST_H_
#define MPU6050_FIRST_INC_IOIF_MPU6050_FIRST_H_
...
#define IOIF_MPU6050_FIRST_BUFF_SIZE        32

#define IOIF_MPU6050_FIRST_TRIALS           10
#define IOIF_MPU6050_FIRST_STRAT_UP_DELAY   10
#define IOIF_MPU6050_FIRST_TIMEOUT          1
 ...
 */
typedef enum _IOIF_6AxisState1_t {
    IOIF_IMU6AXIS_FIRST_STATUS_OK = 0,
    IOIF_IMU6AXIS_FIRST_STATUS_ERROR,
    IOIF_IMU6AXIS_FIRST_STATUS_BUSY,
    IOIF_IMU6AXIS_FIRST_STATUS_TIMEOUT,
} IOIF_6AxisState1_t;

/**
 * @brief Structure to hold the data from the 6-axis IMU.
 */
typedef struct _IOIF_6AxisData1_t {
    float accX;
    float accY;
    float accZ;
...
IOIF_6AxisState1_t IOIF_Init6Axis1(I2C_HandleTypeDef* i2c);
IOIF_6AxisState1_t IOIF_Get6AxisValue1(IOIF_6AxisData1_t* imuData);


#endif /* MPU6050_FIRST_INC_IOIF_MPU6050_FIRST_H_ */
